...
d3.csv(
  "https://raw.githubusercontent.com/DSBaoPhuc/Data-Visualization-Project/main/manage_data/Popularity%20of%20Programming%20Languages%20from%202004%20to%202023.csv"
).then(function (data) {
  data
    .map((d) => d["Date"])
    .forEach((option) => {
